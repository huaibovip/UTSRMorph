...
import losses
import models_oasis.UTSRMorph_dice as UTSRMorph
import utils
from data import datasets, trans
from models_oasis.UTSRMorph_dice import CONFIGS as CONFIGS_UM
...
def main():
    batch_size = 1
    train_dir = r'/home/zrs/CTMRI/OASIS_L2R_2021_task03/All/'
    val_dir = r'/home/zrs/CTMRI/OASIS_L2R_2021_task03/Test/'
    ...
    val_composed = transforms.Compose(
        [trans.NumpyType((np.float32, np.int16))])
    train_set = datasets.OASISBrainDataset(glob.glob(train_dir + '*.pkl'),
                                           transforms=train_composed)
    val_set = datasets.OASISBrainInferDataset(glob.glob(val_dir + '*.pkl'),
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            ...
            print(
                ...
                .format(idx, len(train_loader), loss.item(), loss_ncc.item(),
                        loss_dsc.item(), loss_reg.item()))
